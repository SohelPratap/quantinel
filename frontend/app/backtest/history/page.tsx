      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-foreground">Backtest History</h1>
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{strategies.length} backtests</span>
          </div>
        </div>
        ...
        <div className="grid gap-4">
          {strategies.map((strategy) => (
            <Link
              key={strategy.id}
              href={`/backtest/history/${strategy.id}`}
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div
                    className={cn(
                      ...
                      strategy.status === "profitable" ? "bg-[#10B981]/20" : "bg-[#EF4444]/20"
                    )}
                  >
                ...
                <div className="flex items-center gap-8">
                  ...
                  <div className="text-right">
                    <span className="text-lg font-semibold text-foreground">{strategy.winRate}</span>
                    <p className="text-xs text-muted-foreground">Win Rate</p>
                  </div>
                  <div className="text-right">
                    <span className="text-lg font-semibold text-foreground">{strategy.trades}</span>
