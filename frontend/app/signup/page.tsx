    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="glass-panel rounded-2xl p-8 w-full max-w-md relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-xl font-semibold text-foreground">Quantinel</span>
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">
            Start backtesting strategies in minutes
          </p>
        </div>
                ...
                {passwordRequirements.map((req, i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      req.test(password) ? "text-[#10B981]" : "text-muted-foreground"
                    )}
                  >
                    <Check className={cn("w-3 h-3", !req.test(password) && "opacity-30")} />
                    {req.label}
                  </div>
                ))}
              </div>
